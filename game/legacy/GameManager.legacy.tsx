/**
 * GAME MANAGER (LEGACY / NON-AUTHORITATIVE)
 *
 * ⚠️ QUARANTINED - DO NOT IMPORT ⚠️
 *
 * WARNING:
 * This class depends on client-side GameEngine and RulesEngine which are quarantined.
 * The server is authoritative for game creation and state management.
 *
 ...
 *
 * For game creation, use server endpoints directly.
 */
...
import { ShapeshipsRulesEngine } from '../engine/RulesEngine.clientLegacy';
