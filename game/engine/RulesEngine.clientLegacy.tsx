/**
 * CLIENT LEGACY — DO NOT USE
 *
 * This file is quarantined. The server is authoritative for phase progression.
 * The client must read phase strings from:
 *   gameState.gameData.currentPhase
 *   gameState.gameData.currentSubPhase
 *
 * This code remains only as historical reference / test scaffolding.
 * Do not import this from active UI, server, or production runtime paths.
 */
...
import { GamePhasesEngine, MajorPhase, BuildPhaseStep, BattlePhaseStep } from './GamePhases.clientLegacy';
