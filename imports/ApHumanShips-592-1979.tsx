import svgPaths from "./svg-x7l65be2v7";
...
export default function ApHumanShips() {
  return (
    <div className="relative size-full" data-name="AP - Human Ships">
      <div className="absolute flex h-[398px] items-center justify-center left-[406px] top-0 w-px" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-px relative w-[398px]" data-name="VR">
            <div className="absolute bottom-full left-0 right-0 top-[-100%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 398 1">
                <line id="VR" stroke="var(--stroke-0, #555555)" x2="398" y1="0.5" y2="1.49998" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute content-stretch flex flex-col gap-[5px] items-center left-[955px] top-[143px]" data-name="Leviathan and Cost">
        <div className="h-[222.123px] relative shrink-0 w-[239px]" data-name="Leviathan">
      ...
      <div className="absolute content-stretch flex flex-col gap-[7px] items-center left-[994px] top-0 w-[198px]" data-name="Dreadnought and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[13px] items-center left-[813px] top-[32px] w-[211px]" data-name="Earth Ship and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[7px] items-center left-[689px] top-0 w-[183px]" data-name="Battlecruiser and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[7px] items-center left-[642px] top-[116px] w-[138px]" data-name="Science Vessel and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[7px] items-center left-[530px] top-[31px] w-[129px]" data-name="Tactical Cruiser and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[7px] items-center left-[448px] top-[181px] w-[180px]" data-name="Guardian and Cost">
      ...
      <div className="absolute content-stretch flex flex-col gap-[9px] items-center left-[451px] top-[53px] w-[52px]" data-name="Frigate and Cost">
      ...
      <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[427px] text-[18px] text-nowrap text-white top-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        Human Upgraded Ships
      </p>
      <div className="absolute content-stretch flex items-center justify-between left-[3px] top-[127px] w-[368px]" data-name="Basic Row 2">
      ...
      <div className="absolute content-stretch flex items-end justify-between left-0 top-[38px] w-[371px]" data-name="Basic Row 1">
      ...
      <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-0 text-[18px] text-nowrap text-white top-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        Human Basic Ships
      </p>
    </div>
  );
