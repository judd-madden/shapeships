import svgPaths from "./svg-9ymiba48xy";
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-0 right-[824px] top-[33px]">
      <MercuryCoreAndCost />
      <PlutoCoreAndCost />
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-[-5px] px-[16px] right-[819px] top-[165px]">
      <UranusCoreAndCost />
