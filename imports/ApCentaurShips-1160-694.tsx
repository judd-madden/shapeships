import svgPaths from "./svg-u87s1y1xaw";
...
function BasicShipsRow() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-0 right-[824px] top-[33px]" data-name="Basic Ships Row 1">
      <MercuryCoreAndCost />
      <PlutoCoreAndCost />
...
function BasicShipsRow1() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-[-5px] px-[16px] right-[819px] top-[165px]" data-name="Basic Ships Row 2">
      <UranusCoreAndCost />
...
function SolarPowersWrapper() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[427px] right-0 top-[67px]" data-name="Solar Powers Wrapper">
      <MercurianPowers />
      <PlutonianPowers />
      <UranianPowers />
      <BinaryPowers />
...
function BlackHole() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start opacity-50 right-0 top-[280px] w-[188px]" data-name="Black Hole">
      <SpButton7 />
