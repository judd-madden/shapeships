import svgPaths from "./svg-j2ah4xk357";
...
export default function ApHumanShips() {
  return (
    <div className="relative size-full" data-name="AP - Human Ships">
      ...
      <div className="absolute contents left-[calc(50%+479.5px)] top-[calc(50%+71.56px)] translate-x-[-50%] translate-y-[-50%]" data-name="Leviathan and Cost">
        <div className="absolute h-[222.123px] left-[calc(50%+479.5px)] top-[calc(50%+71.56px)] translate-x-[-50%] translate-y-[-50%] w-[239px]" data-name="Leviathan">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+549.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%-4.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          44
        </p>
      </div>
      <div className="absolute contents left-[calc(50%+498px)] top-[calc(50%-118px)] translate-x-[-50%] translate-y-[-50%]" data-name="Dreadnought and Cost">
        <div className="absolute h-[105px] left-[calc(50%+498px)] top-[calc(50%-132px)] translate-x-[-50%] translate-y-[-50%] w-[198px]" data-name="Dreadnought">
          ...
          <Commander additionalClassNames="inset-[54.29%_37.88%_0_37.88%]">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+497.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%-72.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          27
        </p>
      </div>
      <div className="absolute contents left-[calc(50%+323.5px)] top-[calc(50%-50.5px)] translate-x-[-50%] translate-y-[-50%]" data-name="Earth Ship and Cost">
        <div className="absolute h-[166px] left-[calc(50%+323.5px)] top-[calc(50%-67.5px)] translate-x-[-50%] translate-y-[-50%] w-[211px]" data-name="Earth Ship">
          ...
          <Wrapper2 additionalClassNames="absolute inset-[51.2%_27.96%_0_27.96%]">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+323.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%+28.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          23
        </p>
      </div>
      <div className="absolute contents left-[calc(50%+185.5px)] top-[calc(50%-111.5px)] translate-x-[-50%] translate-y-[-50%]" data-name="Battlecruiser and Cost">
        <div className="absolute h-[114px] left-[calc(50%+185.5px)] top-[calc(50%-125.5px)] translate-x-[-50%] translate-y-[-50%] w-[183px]" data-name="Battlecruiser">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+185.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%-61.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          20
        </p>
      </div>
      <div className="absolute contents left-[calc(50%+116px)] top-[calc(50%+4px)] translate-x-[-50%] translate-y-[-50%]" data-name="Science Vessel and Cost">
        <div className="absolute h-[113px] left-[calc(50%+116px)] top-[calc(50%-10px)] translate-x-[-50%] translate-y-[-50%] w-[138px]" data-name="Science Vessel">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%+115.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%+53.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          17
        </p>
      </div>
      <div className="absolute contents left-[calc(50%-0.5px)] top-[calc(50%-81.5px)] translate-x-[-50%] translate-y-[-50%]" data-name="Tactical Cruiser and Cost">
        <div className="absolute h-[112px] left-[calc(50%-0.5px)] top-[calc(50%-95.5px)] translate-x-[-50%] translate-y-[-50%] w-[129px]" data-name="Tactical Cruiser">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%-0.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%-32.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          10
        </p>
      </div>
      <div className="absolute contents left-[calc(50%-57px)] top-[calc(50%+36.5px)] translate-x-[-50%] translate-y-[-50%]" data-name="Guardian and Cost">
        <div className="absolute h-[48px] left-[calc(50%-57px)] top-[calc(50%+22.5px)] translate-x-[-50%] translate-y-[-50%] w-[180px]" data-name="Guardian">
          ...
          <Commander additionalClassNames="inset-[0_36.67%]">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%-57.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%+53.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          12
        </p>
      </div>
      <div className="absolute contents left-[calc(50%-118px)] top-[calc(50%-70.5px)] translate-x-[-50%] translate-y-[-50%]" data-name="Frigate and Cost">
        <div className="absolute h-[88px] left-[calc(50%-118px)] top-[calc(50%-85.5px)] translate-x-[-50%] translate-y-[-50%] w-[52px]" data-name="Frigate">
        ...
        <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[calc(50%-118.5px)] text-[18px] text-center text-nowrap text-white top-[calc(50%-32.5px)] translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
          8
        </p>
      </div>
      ...
      <div className="absolute content-stretch flex items-center justify-between leading-[0] left-[23px] top-[148px] w-[368px]" data-name="Basic Row 2">
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Orbital and Cost">
          <div className="[grid-area:1_/_1] h-[70px] ml-0 mt-0 relative w-[79px]" data-name="Orbital">
            <Wrapper5>
              <path d={svgPaths.p288d0780} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, #62FFF6)" strokeMiterlimit="10" strokeWidth="4" />
            </Wrapper5>
          </div>
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[39.5px] mt-[77px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            6
          </p>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Carrier and Cost">
          <div className="[grid-area:1_/_1] h-[81px] ml-0 mt-0 relative w-[93px]" data-name="Carrier">
          ...
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[46.5px] mt-[88px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            6
          </p>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Starship and Cost">
          <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[102px]" data-name="Starship">
            <Wrapper8>
              <path d={svgPaths.p184f1080} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, #FF86E4)" strokeMiterlimit="10" strokeWidth="4" />
            </Wrapper8>
          </div>
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[50.5px] mt-[109px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            8
          </p>
        </div>
      </div>
      <div className="absolute content-stretch flex items-end justify-between leading-[0] left-[20px] top-[59px] w-[371px]" data-name="Basic Row 1">
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Defender and Cost">
          <div className="[grid-area:1_/_1] h-[32px] ml-0 mt-0 relative w-[52px]" data-name="Defender">
            <Wrapper7>
              <path d={svgPaths.p35825300} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, #9CFF84)" strokeMiterlimit="10" strokeWidth="4" />
            </Wrapper7>
          </div>
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[25.5px] mt-[42px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            2
          </p>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Fighter and Cost">
          <div className="[grid-area:1_/_1] h-[45px] ml-0 mt-0 relative w-[52px]" data-name="Fighter">
            <Wrapper6>
              <path d={svgPaths.p27c75d00} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, #FF8282)" strokeMiterlimit="10" strokeWidth="4" />
            </Wrapper6>
          </div>
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[25.5px] mt-[53px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            3
          </p>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Commander and Cost">
          <div className="[grid-area:1_/_1] ml-0 mt-0 relative size-[48px]" data-name="Commander">
            <Wrapper1>
              <path d="M46 2V46H2V2H46Z" fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, #FFBB56)" strokeMiterlimit="10" strokeWidth="4" />
            </Wrapper1>
          </div>
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[23.5px] mt-[55px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            4
          </p>
        </div>
        <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Interceptor and Cost">
          <div className="[grid-area:1_/_1] h-[52px] ml-0 mt-0 relative w-[61px]" data-name="Interceptor">
          ...
          <p className="[grid-area:1_/_1] font-['Roboto:Bold',sans-serif] font-bold leading-[normal] ml-[30.5px] mt-[57px] relative text-[18px] text-center text-nowrap text-white translate-x-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
            4
          </p>
        </div>
      </div>
