import svgPaths from "./svg-4b3chkmjof";
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-[-412px] right-[824px] top-[33px]">
      <MercuryCoreAndCost />
      <PlutoCoreAndCost />
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-[-417px] px-[16px] right-[819px] top-[165px]">
      <UranusCoreAndCost />
...
function EnergyCountWrapper() {
  return (
    <div className="absolute content-stretch flex gap-[32px] items-center right-[2px] top-[4px]" data-name="Energy Count Wrapper">
          ...
          <div className="relative shrink-0 size-[14.4px]">
            <div className="absolute inset-[-6.42%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.248 16.248">
                <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
              </svg>
            </div>
          </div>
        </div>
    ...
    <div className="h-[14.4px] relative shrink-0 w-[55.2px]">
      <div className="absolute inset-[-6.42%_-1.67%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 57.048 16.248">
          <g id="Frame 219">
            <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
            <circle cx="28.524" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 2" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
...
function Supernova() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Supernova">
      <SpButton1 />
...
function StarBirth() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Star Birth">
      <SpButton3 />
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-center px-[20px] py-[19px] relative size-full">
          ...
          <div className="relative shrink-0 size-[14.4px]">
            <div className="absolute inset-[-6.42%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.248 16.248">
                <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #62FFF6)" strokeWidth="1.848" />
              </svg>
            </div>
          </div>
        </div>
...
function Siphon() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Siphon">
      <SpButton5 />
    ...
    <div className="h-[14.4px] relative shrink-0 w-[32.8px]">
      <div className="absolute inset-[-6.42%_-2.82%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34.648 16.248">
          <g id="Frame 221">
            <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
            <circle cx="26.524" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 2" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
          </g>
        </svg>
      </div>
    </div>
...
function Vortex() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0 w-full" data-name="Vortex">
      <SpButton6 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[15px] text-center text-white w-full whitespace-pre-wrap">Deal X damage</p>
    </div>
  );
...
function SolarPowersWrapper() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[15px] right-0 top-[67px]" data-name="Solar Powers Wrapper">
      <MercurianPowers />
      <PlutonianPowers />
      <UranianPowers />
      <BinaryPowers />
    ...
    <div className="h-[51.2px] relative shrink-0 w-[14.4px]">
      <div className="absolute inset-[-1.8%_-6.42%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.248 53.048">
          <g id="Frame 221">
            <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
            <circle cx="8.124" cy="26.524" fill="var(--fill-0, black)" id="Ellipse 2" r="7.2" stroke="var(--stroke-0, #FF8282)" strokeWidth="1.848" />
    ...
    <div className="h-[51.2px] relative shrink-0 w-[14.4px]">
      <div className="absolute inset-[-1.8%_-6.42%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.248 53.048">
          <g id="Frame 242">
            <circle cx="8.124" cy="8.124" fill="var(--fill-0, black)" id="Ellipse 1" r="7.2" stroke="var(--stroke-0, #62FFF6)" strokeWidth="1.848" />
            <circle cx="8.124" cy="26.524" fill="var(--fill-0, black)" id="Ellipse 2" r="7.2" stroke="var(--stroke-0, #62FFF6)" strokeWidth="1.848" />
            <circle cx="8.124" cy="44.924" fill="var(--fill-0, black)" id="Ellipse 3" r="7.2" stroke="var(--stroke-0, #62FFF6)" strokeWidth="1.848" />
          </g>
        </svg>
      </div>
    </div>
...
function BlackHole() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start right-0 top-[280px] w-[188px]" data-name="Black Hole">
      <SpButton7 />
...
export default function ApCentaurShips() {
  return (
    <div className="bg-[#101010] relative size-full" data-name="AP - Centaur Ships">
      <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[-412px] text-[18px] text-white top-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        Ancient Basic Ships
      </p>
      <p className="absolute font-['Roboto:Bold',sans-serif] font-bold leading-[normal] left-[15px] text-[18px] text-white top-0" style={{ fontVariationSettings: "'wdth' 100" }}>
        Ancient Solar Powers
      </p>
      <div className="absolute bg-[#555] h-[469px] left-[-6px] top-0 w-px" data-name="VR" />
      <Frame11 />
      <Frame12 />
      <EnergyCountWrapper />
      <SolarPowersWrapper />
