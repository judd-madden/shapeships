    ...
    >
      ...
      >
        <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 text-black w-[180px]">
          <p
            className="font-black leading-[normal] relative shrink-0 text-[22px] text-left uppercase w-full"
          >
            {title}
          </p>
          <p
            className="font-medium leading-[20px] relative shrink-0 text-[13px] text-left w-full"
          >
            {blurbLines.join(' ')}
          </p>
        </div>
