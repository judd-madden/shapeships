  ...
  human: {
    ...
    content: (
      <>
        ...
        <p>High-tech <span style={{ color: 'var(--shapeships-pastel-blue)' }}>Orbitals</span> Orbitals hang in space, the backbone of the human economy. Huge <span style={{ color: 'var(--shapeships-pastel-yellow)' }}>Carriers</span> mass <span style={{ color: 'var(--shapeships-pastel-red)' }}>Fighters</span> and <span style={{ color: 'var(--shapeships-pastel-green)' }}>Defenders</span> - soldiers in this endless war. This quest for more.</p>
        <p><span style={{ color: 'var(--shapeships-pastel-purple)' }}>Interceptors</span> can turn the battle. <span style={{ color: 'var(--shapeships-orange)' }}>Tactical Cruisers</span> can lay siege - but it’s the truly vast ships that inspire: witness the mighty <span style={{ color: 'var(--shapeships-cyan)' }}>Battlecruiser</span>, the grand <span style={{ color: 'var(--shapeships-green)' }}>Earth Ship</span>, the infamous <span style={{ color: 'var(--shapeships-green)' }}>Dreadnought</span>. These marvels of humanity, these ICONS. These supreme tools of protection, expansion, destruction.</p>
  ...
  xenite: {
    ...
    content: (
      <>
        ...
        <p>It is made of many, many parts. The ubiquitous <strong>Xenites</strong>, empowering the swarm - ready to evolve or become a <span style={{ color: 'var(--shapeships-cyan)' }}>Queen</span>. <span style={{ color: 'var(--shapeships-pastel-blue)' }}>Bug Breeders</span> that spawn, even more dangerous when they are depleted husks.</p>
        <p>The strange <span style={{ color: 'var(--shapeships-blue)' }}>Evolved</span> <span style={{ color: 'var(--shapeships-yellow)' }}>Faces</span>, impossible for a Human to describe in words. It wants more <span style={{ color: 'var(--shapeships-cyan)' }}>Queens</span>. <span style={{ color: 'var(--shapeships-green)' }}>Defense Swarms</span> buy time. Witness its massive <span style={{ color: 'var(--shapeships-pastel-yellow)' }}>Zeniths</span>, themselves only a prelude to something much scarier: the <span style={{ color: 'var(--shapeships-pink)' }}>Chronoswarm</span>.</p>
  ...
  ancient: {
    ...
    content: (
      <>
        ...
        <p>The <span style={{ color: 'var(--shapeships-red)' }}>Asteroids</span>, the <span style={{ color: 'var(--shapeships-red)' }}>Supernova</span>. <span style={{ color: 'var(--shapeships-green)' }}>Life</span> and <span style={{ color: 'var(--shapeships-green)' }}>Star Birth</span>. Perhaps not literally anymore - but maybe they once were, when the Ancients were at full power.</p>
