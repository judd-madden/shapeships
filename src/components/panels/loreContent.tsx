  ...
  human: {
    ...
    content: (
      <>
        ...
        <p>High-tech Orbitals hang in space, the backbone of the human economy. Huge Carriers mass Fighters and Defenders - soldiers in this endless war. This quest for more.</p>
        <p>Interceptors can turn the battle. Tactical Cruisers can lay siege - but it’s the truly vast ships that inspire: witness the mighty Battlecruiser, the grand Earth Ship, the infamous Dreadnought. These marvels of humanity, these ICONS. These supreme tools of protection, expansion, destruction.</p>
        <p>And then of course there are the Starships, the first great steps on the path to Science. To the manipulation of reality itself: Science Vessels, and the Leviathan.</p>
  ...
  xenite: {
    ...
    content: (
      <>
        ...
        <p>The brain has cancer. Filthy Humans. Arrogant Centaurs. Ravaging its planets for resources.</p>
        <p>This is its galaxy. They are the invaders.</p>
        <p>It is made of many, many parts. The ubiquitous Xenites, empowering the swarm - ready to evolve or become a Queen. Bug Breeders that spawn, even more dangerous when they are depleted husks.</p>
        <p>The strange Evolved Faces, impossible for a Human to describe in words.</p>
        <p>It wants more Queens. Defense Swarms buy time. Witness its massive Zeniths, themselves only a prelude to something much scarier: the Chronoswarm.</p>
        <p><strong>The Hive will win. It always has.</strong></p>
      </>
    ),
  },
  centaur: {
    ...
    content: (
      <>
        ...
        <p>They embrace fear and anger - even terror and fury. They conquer with Vigor, Wisdom, Equality. With Family.</p>
        <p>Admire their Arks, principles captured in perfect form. With Knowledge they can change reality. With Power they can proliferate. Their behemoths: the Arks of Destruction and Domination - both harnessing the entire weight of the Centaur fleet.</p>
  ...
  ancient: {
    ...
    content: (
      <>
        ...
        <p>By most Human definitions, the Ancients are gods. Harvesting solar energy unlike any of the other species. Quantum Mystics. Cores of energy. Cubes that manipulate time.</p>
        <p>The red Asteroids, the Supernova. Green Life and Star Birth. Perhaps not literally anymore - but maybe they once were, when the Ancients were at full power.</p>
        <p>Blue unlocks Simulacrum. They created you and they can become you. Survive long enough and you'll see the Siphon, the Vortex. The Black Hole. They want to return to peaceful slumber. Enough war.</p>
