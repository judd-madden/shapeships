    ...
    <div className="content-stretch flex flex-col gap-[40px] items-start relative w-full">
      ...
      <div className="content-stretch flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative shrink-0 w-full">
        <div className="content-stretch flex flex-col gap-[9px] items-start leading-[normal] relative shrink-0">
          <p className="font-['Roboto',sans-serif] font-black relative shrink-0 text-[36px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
            Create Private Game
          </p>
          <p className="font-['Roboto',sans-serif] font-normal relative shrink-0 text-[20px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          <div className="content-stretch flex flex-col md:flex-row gap-[40px] md:gap-[72px] items-start md:items-center pl-0 md:pl-[50px] pr-0 py-0 relative w-full">
            ...
            <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
              ...
              >
                ...
                <p className="font-['Roboto',sans-serif] font-bold leading-[normal] relative shrink-0 text-[26px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
                  Not timed
                </p>
              </div>
              {/* Timed */}
              ...
              <div className="content-stretch flex flex-col md:flex-row gap-[32px] md:gap-[52px] items-start md:items-center relative shrink-0">
                ...
                <div className="content-stretch flex flex-col gap-[12px] items-start justify-center relative shrink-0">
                  <div className="bg-black content-stretch flex items-center justify-between p-[10px] relative rounded-[10px] shrink-0 w-[180px]">
                    ...
                    <p className="font-['Roboto',sans-serif] font-black leading-[36px] relative shrink-0 text-[36px] text-nowrap flex-1" style={{ fontVariationSettings: "'wdth' 100" }}>
                      <span>{minutes} </span>
                      <span className="font-['Roboto',sans-serif] font-normal" style={{ fontVariationSettings: "'wdth' 100" }}>
                        min
                      </span>
                    </p>
                    <ChevronDown />
                  </div>
                  <p className="font-['Roboto',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
                    Each player
                  </p>
                </div>
      ...
      <div className="bg-[rgba(0,0,0,0.5)] relative rounded-[14px] shrink-0 w-full">
        ...
        <div className="content-stretch flex flex-col items-start px-[37px] py-[34px] relative w-full">
          <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
            ...
            <p className="font-['Roboto',sans-serif] font-bold leading-[normal] relative shrink-0 text-[36px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
              1v1 Standard
            </p>
          </div>
        </div>
      ...
      <div className="bg-black opacity-30 relative rounded-[14px] shrink-0 w-full pointer-events-none">
        ...
        <div className="content-stretch flex flex-col gap-[40px] items-start px-[40px] py-[35px] relative w-full">
          ...
          <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
            ...
            <p className="font-['Roboto',sans-serif] font-bold leading-[normal] relative shrink-0 text-[36px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
              1v1 Variant
              <span className="font-['Roboto',sans-serif] font-light" style={{ fontVariationSettings: "'wdth' 100" }}>
                {` (future)`}
              </span>
            </p>
          </div>
            ...
            <div className="gap-[50px] grid grid-cols-1 md:grid-cols-2 grid-rows-[repeat(3,_minmax(0px,_1fr))] pb-[40px] pl-0 md:pl-[30px] pr-0 pt-0 relative w-full">
              ...
              <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0">
                <div className="content-stretch flex gap-[10px] items-center justify-start relative shrink-0 w-full">
                  ...
                  <p className="basis-0 font-['Roboto',sans-serif] font-semibold grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[18px]">
                    Quick Start
                  </p>
                </div>
                <div className="content-stretch flex items-center pl-[40px] pr-0 py-0 relative shrink-0 w-full">
                  <p className="basis-0 font-['Roboto',sans-serif] font-normal grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[16px]">
              ...
              <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0">
                ...
                <div className="content-stretch flex items-center pl-[40px] pr-0 py-0 relative shrink-0 w-full">
                  <p className="basis-0 font-['Roboto',sans-serif] font-normal grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[16px]">
                    <span className="font-['Roboto',sans-serif] italic">Guardian</span>
                    {` and `}
                    <span className="font-['Roboto',sans-serif] italic">Black Hole</span>
                    {` are banned, and `}
                    <span className="font-['Roboto',sans-serif] italic">Ships of Equality</span>
