...
export const speciesLore: Record<SpeciesLoreId, SpeciesLore> = {
  human: {
    ...
    content: (
      <>
        <p>Humans have always wanted MORE. More things. More places to go. More problems to solve. Always looking to the future, to the beyond. Always looking for more — so naturally they expanded. It’s a big galaxy. Plenty of systems for everyone, right?</p>
