...
export function CoreRulesPanel({ onNavigate }: CoreRulesPanelProps) {
  return (
    <div className="content-stretch flex flex-col gap-[16px] sm:gap-[36px] items-start relative shrink-0 w-full px-[16px] pt-[12px] pb-[24px]  sm:px-[50px] sm:pt-[32px] sm:pb-[50px] bg-black/60 rounded-[10px]">
      {/* Page Title */}
