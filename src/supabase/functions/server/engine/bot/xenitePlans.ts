...
const XEN_FACES_PLAN: AuthoredBotPlan = {
  ...
  orderedBuildPlan: {
    buildOrder: [
      ...
      'EVO',
      { shipDefId: 'ASF', saveUntilAffordable: true, fallbackShipDefIds: ['BUG', 'EVO', 'ZEN'] },
      { shipDefId: 'QUE', saveUntilAffordable: true, fallbackShipDefIds: ['ANT'] },
      { shipDefId: 'QUE', saveUntilAffordable: true, fallbackShipDefIds: ['ANT'] },
    ],
    endLoop: [
      'BUG',
      'EVO',
      { shipDefId: 'ASF', saveUntilAffordable: true, fallbackShipDefIds: ['BUG', 'EVO'] },
      'EVO',
      { shipDefId: 'OXF', saveUntilAffordable: true, fallbackShipDefIds: ['BUG', 'EVO'] },
    ],
    fallbacks: {
      default: ['BUG', 'EVO', 'ZEN'],
      defensive: ['BUG', 'ZEN'],
