...
export const RejectionCode = {
  ...
  DRAWING_PRELUDE_INCOMPLETE: 'DRAWING_PRELUDE_INCOMPLETE',
  DRAWING_PRELUDE_UNSUPPORTED: 'DRAWING_PRELUDE_UNSUPPORTED',
  ...
  // Mission intro gating
  MISSION_INTRO_PENDING: 'MISSION_INTRO_PENDING',
  MISSION_INTRO_UNAVAILABLE: 'MISSION_INTRO_UNAVAILABLE',
